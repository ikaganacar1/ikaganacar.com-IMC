...
def movie_page(movie_id):
    ...
    return render_template(
        "movie_collection/movie_page.html",
        movie=movie,
...
def person_page(person_id):
    ...
    return render_template(
        "movie_collection/person_page.html",
        person=person,
        current_user=current_user,
        logged_in=True,
    )
...
def watched(user_id):
    ...
    return render_template(
        "movie_collection/movies_wathced.html", response=templist
    )
...
def watchlist(user_id):
    ...
    return render_template(
        "movie_collection/movies_watchlist.html", response=templist
    )
...
def follow_page(user_id):
    ...
    return render_template(
        "movie_collection/movies_friends.html",
        user_list=user_list,
...
def invite_friend(user_id):
    ...
    return render_template(
        "movie_collection/movies_invitation.html",
...
def search(search_word):
    ...
    return render_template(
        "movie_collection/movies_search.html",
...
def movies_login():
    ...
    return render_template("movie_collection/movies_login.html")
...
def movies_register():
    ...
    return render_template("movie_collection/movies_register.html")
